    ...
    if($MontoTransferenciaCuentas === "") {
        ...
        $.ajax({
            ...
            beforeSend: function(objeto) {
                $("#resultados_transferencias").html('<div class="alert alert-light solid alert-dismissible fade show"><img style="width: 30px;" class="img-fluid" src="/CashManHA/vista/images/Hourglass.gif"><strong>¡Procesando Informaci&oacute;n!</strong> Espere un momento...</div>');
            },
