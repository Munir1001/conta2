...
function LimpiezaDatos() {
    ...
    document.getElementById('calculodesembolso').innerHTML = "0.00";
    document.getElementById('monto-credito-solicitado').innerHTML = "0.00";
    document.getElementById('plazo-credito').innerHTML = "0 meses";
    document.getElementById('SeguroDesgravamen').innerHTML = "0.00";
    document.getElementById('ahorroprogramado').innerHTML = "0.00";
}
