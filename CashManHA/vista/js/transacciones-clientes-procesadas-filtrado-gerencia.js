$(document).ready(function () {
    ...
    function actualizarContadores(total, porPagina, paginaActual) {
        if (total === 0) {
            ...
            // Actualizar todos los elementos con id showing-from-gerencia
            document.querySelectorAll('[id="showing-from-gerencia"]').forEach(el => el.textContent = '0');

            // Actualizar todos los elementos con id showing-to-gerencia
            document.querySelectorAll('[id="showing-to-gerencia"]').forEach(el => el.textContent = '0');
        ...
        // Actualizar todos los elementos con id showing-from-gerencia
        document.querySelectorAll('[id="showing-from-gerencia"]').forEach(el => el.textContent = inicio);

        // Actualizar todos los elementos con id showing-to-gerencia
        document.querySelectorAll('[id="showing-to-gerencia"]').forEach(el => el.textContent = fin);
    }
