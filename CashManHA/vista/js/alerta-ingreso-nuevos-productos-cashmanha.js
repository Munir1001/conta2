...
$("#ingreso-nuevos-productos").submit(function(event) {
   ...
   var $CodigoProductos = $('#val-codigoproducto').val(); // CODIGO DE PRODUCTOS
        ...
        $.ajax({
            type: "POST",
            url: "/CashManHA/controlador/cGestionesCashman.php?cashmanhagestion=envio-datos-registro-nuevos-productos",
            data: parametros,
            ...
            success: function(datos) {
                ...
                // SI LA PETICION ES ACEPTADA, MOSTRAR MENSAJE DE CONFIRMACION DE PETICION EXITOSA
                    ...
                    setTimeout(function () {
                        //location.reload();
                        location.href = "/CashManHA/controlador/cGestionesCashman.php?cashmanhagestion=consultar-productos-cashmanha";
                    }, 6000);
                }
