...
$("#ingreso-nuevos-roles-usuarios").submit(function(event) {
   ...
   if ($DescripcionRolUsuarios === "") {
       ...
       return false;
        ...
        $.ajax({
            type: "POST",
            url: "/CashManHA/controlador/cGestionesCashman.php?cashmanhagestion=envio-datos-registro-roles-usuarios",
            data: parametros,
            ...
            success: function(datos) {
                ...
                // SI LA PETICION ES ACEPTADA, MOSTRAR MENSAJE DE CONFIRMACION DE PETICION EXITOSA
                    ...
                    setTimeout(function () {
                        //location.reload();
                        location.href = "/CashManHA/controlador/cGestionesCashman.php?cashmanhagestion=consulta-roles-usuarios";
                    }, 6000);
                }
