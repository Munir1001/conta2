$(document).ready(function () {
    ...
    function actualizarContadores(total, porPagina, paginaActual) {
        if (total === 0) {
            ...
            // Actualizar todos los elementos con id showing-from
            document.querySelectorAll('[id="showing-from"]').forEach(el => el.textContent = '0');

            // Actualizar todos los elementos con id showing-to
            document.querySelectorAll('[id="showing-to"]').forEach(el => el.textContent = '0');
        ...
        // Actualizar todos los elementos con id showing-from
        document.querySelectorAll('[id="showing-from"]').forEach(el => el.textContent = inicio);

        // Actualizar todos los elementos con id showing-to
        document.querySelectorAll('[id="showing-to"]').forEach(el => el.textContent = fin);
    }
