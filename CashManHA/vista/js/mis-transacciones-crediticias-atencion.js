$(document).ready(function () {
    ...
    function actualizarContadores(total, porPagina, paginaActual) {
        if (total === 0) {
            ...
            // Actualizar todos los elementos con id showing-from-atencion
            document.querySelectorAll('[id="showing-from-atencion"]').forEach(el => el.textContent = '0');

            // Actualizar todos los elementos con id showing-to-atencion
            document.querySelectorAll('[id="showing-to-atencion"]').forEach(el => el.textContent = '0');
        ...
        // Actualizar todos los elementos con id showing-from-atencion
        document.querySelectorAll('[id="showing-from-atencion"]').forEach(el => el.textContent = inicio);

        // Actualizar todos los elementos con id showing-to-atencion
        document.querySelectorAll('[id="showing-to-atencion"]').forEach(el => el.textContent = fin);
    }
