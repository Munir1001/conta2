    ...
    try{
        ...
        if(MontoCredito==0 | PlazoCredito==0 | MontoCredito=="" | PlazoCredito==""){
            ...
            if(MontoCredito>=10000 && MontoCredito<=25000){// $10,000.00 - $25,000.00 USD
                 SeguroDesgravamen = 12.99;
                 AhorroProgramado= 25.99;
                 ServicioGPS = 20.99;
             }else if(MontoCredito>25000 && MontoCredito<=50000){// $25,001.00 - $50,000.00 USD
                SeguroDesgravamen = 18.99;
                AhorroProgramado= 29.99;
                ServicioGPS = 20.99;
            }else if(MontoCredito>50000 && MontoCredito<=100000){// $50,001.00 - $100,000.00 USD
                SeguroDesgravamen = 26.99;
                AhorroProgramado= 59.99;
                ServicioGPS = 20.99;
            }else if(MontoCredito>100000 && MontoCredito<=200000){// $100,001.00 - $200,000.00 USD
                SeguroDesgravamen = 37.99;
                AhorroProgramado= 99.99;
                ServicioGPS = 20.99;
            }
             // CALCULO CUOTA MENSUAL A CANCELAR [  IVA INCLUIDO ]
             CalcularCuotaMensual = parseFloat((MontoCredito/PlazoCredito+(MontoCredito/PlazoCredito)*TasaInteres/100)+SeguroDesgravamen+ServicioGPS)*.13+parseFloat((MontoCredito/PlazoCredito+(MontoCredito/PlazoCredito)*TasaInteres/100)+SeguroDesgravamen+ServicioGPS);
        }
        ...
        TotalDesembolso = MontoCredito-ahorroprogramado;
...
function LimpiezaDatos(){
    // VARIABLES GLOBALES
    CalcularCuotaMensual=0; TotalDesembolso=0; CreditoSolicitado=0; MesesPlazo=0; SeguroDesgravamen=0; ahorroprogramado=0; ServicioGPS=0;
