$(document).ready(function () {
    ...
    function actualizarContadores(total, porPagina, paginaActual) {
        if (total === 0) {
            ...
            // Actualizar todos los elementos con id showing-to-clientes
            document.querySelectorAll('[id="showing-to-clientes"]').forEach(el => el.textContent = '0');
        ...
        // Actualizar todos los elementos con id showing-to-clientes
        document.querySelectorAll('[id="showing-to-clientes"]').forEach(el => el.textContent = inicio);

        // Actualizar todos los elementos con id showing-to-clientes
        document.querySelectorAll('[id="showing-to-clientes"]').forEach(el => el.textContent = fin);
    }
