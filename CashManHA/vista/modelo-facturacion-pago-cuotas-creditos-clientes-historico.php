...
$pdf->SetTitle(utf8_decode("Facturación Clientes - InversGlobal"));
$pdf->AliasNbPages();
$pdf->AddPage();
// CONTENIDO DE REPORTE [DOCUMENTO]
$pdf->SetFont('Arial', '', 10);
$pdf->setTextColor(255, 255, 255);
$pdf->MultiCell(191, 8, utf8_decode("Facturación InversGlobal"), 0, 'R');
...
$pdf->SetTextColor(0,0,0);
$pdf->MultiCell(190, 4, utf8_decode("Cédula: " . $Gestiones->getduiUsuarios()));
$pdf->MultiCell(190, 4, utf8_decode("RUC: " . $Gestiones->getNitUsuarios()));
$pdf->Ln(40);
...
$pdf->Ln(5);
$pdf->MultiCell(199, 5, utf8_decode("Total: $ " . number_format($Gestiones->getCuotaTotal(), 2)), 0, 'R');
$pdf->Ln(6);
$pdf->SetFont('Arial', '', 7);
$pdf->MultiCell(190, 4, utf8_decode("EL TOTAL A CANCELAR ES : " . $Conversion->toWords($Gestiones->getCuotaTotal()) . " DOLARES DE LOS ESTADOS UNIDOS DE AMERICA"), 0, 'C');
$pdf->SetFont('Arial', '', 8);
$pdf->Ln(5);
...
$pdf->Ln(45);
$pdf->SetFont('Arial', '', 7);
$pdf->MultiCell(190, 4, utf8_decode("COMPROBANTE OFICIAL DE CANCELACIÓN InversGlobal S.A DE C.V ~ " . $Gestiones->getReferenciaTransaccionCreditosClientes()), 0, 'C');
