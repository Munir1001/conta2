...
?>
    ...
    <head>
        ...
        <title>InversGlobal | Gestor Referencias Personales - Laborales</title>
        <!-- Favicon icon -->
                ...
                <div class="row justify-content-center h-100 align-items-center">
                    <div class="col-md-10">
                        <div class="authincation-content">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="input-group mb-3  input-primary">
                                                                    ...
                                                                    <input type="text" class="form-control" id="val-telefonoreferenciapersonal" name="val-telefonoreferenciapersonal" placeholder="XXXXXXXXXX" onkeypress="return (event.charCode <= 57)" value="<?php echo $Gestiones->getTelefonoReferenciaPersonal(); ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="input-group mb-3  input-primary">
                                                                    ...
                                                                    <input type="text" class="form-control" id="val-telefonoreferencialaboral" name="val-telefonoreferencialaboral" placeholder="XXXXXXXXXX" onkeypress="return (event.charCode <= 57)" value="<?php echo $Gestiones->getTelefonoReferenciaLaboral(); ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            ?>
                                <!-- ENVIO DATOS -->
                                <button type="submit" id="enviar-datos-creditos" class="btn light btn-success">
                                    <i class="ti-hand-point-right"></i> Registrar Referencias Clientes
                                </button>
                            <?php
                                                                // SI EXISTEN REFERENCIAS REGISTRADAS, MOSTRAR BOTON DE ACTUALIZAR INFORMACION
                                                            } else {
                            ?>
                                <!-- ENVIO DATOS -->
                                <button type="submit" id="enviar-datos-creditos" class="btn light btn-info">
                                    <i class="ti-hand-point-right"></i> Actualizar Referencias Clientes
                                </button>
                                <button type="button" id="terminar-asignacion" class="btn light btn-warning">
                                    <i class="ti-hand-point-right"></i> Terminar Asignación de Crédito
                                </button>
                            <?php } ?>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body text-center">
                                            <div class="checkmark-circle">
                                                <div class="checkmark-circle__background"></div>
                                                <div class="checkmark"></div>
                                            </div>
                                            <h4 class="text-primary mb-4">Asignación de Crédito</h4>
                                            <p>Una vez finalizada la asignación de crédito, se debe notificar a Gerencia para que continúe con el siguiente paso de revisión.</p>
    ...
    ***********************************-->
        ...
        <script>
            document.getElementById('terminar-asignacion').addEventListener('click', function() {
                $('#confirmModal').modal('show');
            });

            document.getElementById('confirmBtn').addEventListener('click', function() {
                window.location.href = "<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=asignacion-nuevos-creditos-clientes";
            });
        </script>
    </body>
