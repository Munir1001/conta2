...
?>
        ...
        <head>
            ...
            <title>InversGlobal | Gestor Nuevos Pr&eacute;stamos Hipotecarios</title>
            <!-- Favicon icon -->
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title">Pr&eacute;stamo Hipotecario</h5>
                                                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                                        </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <h4 class="text-primary mb-4">Microcrédito</h4>
                                                                        <div id="DZ_W_TimeLine1" class="widget-timeline dz-scroll style-1 ">
                                                                            <ul class="timeline">
                                                                                <li>
                                                                                    <div class="timeline-badge primary"></div>
                                                                                    <a class="timeline-panel text-muted" href="#">
                                                                                        <span>Propiedad Inmobiliaria</span>
                                                                                        <h6 class="mb-0"><i class="ti-tag"></i> Debe contar con una propiedad inmobiliaria que será utilizada como garantía del préstamo.</h6>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                            ...
                                                                            <ul class="timeline">
                                                                                <li>
                                                                                    <div class="timeline-badge primary"></div>
                                                                                    <a class="timeline-panel text-muted" href="#">
                                                                                        <span>Ingresos Estables</span>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Comprobación de ingresos estables y suficientes para cubrir las cuotas del préstamo, con un nivel de endeudamiento que permita la calificación del crédito.</h6>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                            ...
                                                                            <ul class="timeline">
                                                                                <li>
                                                                                    ...
                                                                                    <a class="timeline-panel text-muted" href="#">
                                                                                        ...
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Estado de cuenta bancario de los últimos seis meses.</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Declaración de impuestos de los últimos dos años (si aplica).</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Certificado laboral o documento que acredite ingresos (para asalariados).</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Certificación de ingresos (para profesionales independientes).</h6>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                            ...
                                                                            <ul class="timeline">
                                                                                <li>
                                                                                    ...
                                                                                    <a class="timeline-panel text-muted" href="#">
                                                                                        ...
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Historial crediticio positivo, sin morosidades ni registros negativos en burós de crédito.</h6>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                            ...
                                                                            <ul class="timeline">
                                                                                <li>
                                                                                    <div class="timeline-badge primary"></div>
                                                                                    <a class="timeline-panel text-muted" href="#">
                                                                                        <span>Avalúo de la Propiedad</span>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Presentar un avalúo reciente de la propiedad que se utilizará como garantía, realizado por un perito autorizado.</h6>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                            ...
                                                                            <ul class="timeline">
                                                                                <li>
                                                                                    ...
                                                                                    <a class="timeline-panel text-muted" href="#">
                                                                                        <span>Edad</span>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Edad mínima de 25 años y máxima de 70 años al momento de finalizar el plazo del préstamo.</h6>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                            ...
                                                                            <ul class="timeline">
                                                                                <li>
                                                                                    ...
                                                                                    <a class="timeline-panel text-muted" href="#">
                                                                                        <span>Seguro</span>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Contratación de un seguro de vida y de daños para la propiedad hipotecada, como requisito para el desembolso del préstamo.</h6>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Todos nuestros créditos cuentan con cuota seguro contra daños, y seguro de deuda</h6>
                                                                    </div>
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <select class="form-control" id="val-productocreditos" name="productocreditos">
                                                                                        ...
                                                                                        while ($filas = mysqli_fetch_array($consulta1)) {
                                                                                            ...
                                                                                            if ($filas['nombreproducto'] != "Cuentas de Ahorro Personales" && $filas['nombreproducto'] != "Depósito a Plazo Fijo" && $filas['nombreproducto'] != "Préstamo de Consumo" && $filas['nombreproducto'] != "Préstamos Quirografarios") {
                                                                                                echo '
                                                                    <option value="';
                                                                                            ...
                                                                                            <div class="media">
                                                                                                ...
                                                                                                <div class="media-body text-white">
                                                                                                    ...
                                                                                                    <ul class="list-group list-group-flush">
                                                                                                        ...
                                                                                                        <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Seguro Desgravamen </span><span><strong>$</strong><strong id="SeguroDesgravamen" class="SeguroDesgravamen"></strong><strong> USD</strong></span> </li>
                                                                                                        <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Ahorro Programado : </span><span><strong>$</strong><strong id="ahorroprogramado" class="ahorroprogramado"></strong><strong> USD</strong></span> </li>
                                                                                                    </ul><br>
