...
?>
    ...
    <head>
        ...
        <title>InversGlobal | Mi Perfil</title>
        <!-- Favicon icon -->
                                    ...
                                    <div class="profile-info">
                                        ...
                                        <div class="profile-details">
                                            <div class="profile-name px-3 pt-2">
                                                ...
                                                <p><span><i class="mdi mdi-coffee-to-go"></i></span> Rol: Contabilidad </p>
                                            </div>
                                                        ...
                                                        <div class="form-validation">
                                                            <form id="actualizar-perfil-detalles-usuarios" class="form-valide" method="post" autocomplete="off">
                                                                <div class="row form-validation">
                                                                    <div class="col-lg-6 mb-2">
                                                                        <div class="form-group">
                                                                            <!--label class="text-label">Cédula <span class="text-danger">*</span></label -->
                                                                            <div class="col-lg-12">
                                                                                <input type="hidden" class="form-control" id="val-dui" name="val-dui" placeholder="XXXXXXXXXX" value="<?php echo $Gestiones->getduiUsuarios(); ?>" onkeypress="return (event.charCode <= 57)">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 mb-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <input type="hidden" class="form-control" id="val-nit" name="val-nit" placeholder="XXXXXXXXXX-XXX" value="<?php echo $Gestiones->getNitUsuarios(); ?>" onkeypress="return (event.charCode <= 57)">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 mb-2">
