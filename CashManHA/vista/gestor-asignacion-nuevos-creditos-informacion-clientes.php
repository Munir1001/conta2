...
?>
    ...
    <head>
        ...
        <title>InversGlobal | Gestor de Nuevos Cr&eacute;ditos InversGlobal</title>
        <!-- Favicon icon -->
                                        ...
                                        <div class="card overflow-hidden">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    ...
                                                    <p>Cliente InversGlobal</p>
                                                    <p>Multimedia Documentos Personales Clientes InversGlobal</p>
                                                </div><br>
                                                <div class="col-xl-12">
                                                    <!-- FOTO dui CLIENTES -->
                                                    <button type="button" class="btn btn-light mb-2" data-toggle="modal" data-target="#fotoduiclientes">Fotograf&iacute;a Cédula Cliente <span class="btn-icon-right"><i class="fa fa-file-image-o"></i></span></button>
                                                    <!-- Modal -->
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <h6><strong>Fotograf&iacute;a Cédula Frontal Cliente.</strong></h6>
                                                                    <img class="img-fluid" src="<?php echo $UrlGlobal; ?>vista/images/fotoduifrontal/<?php echo $Gestiones->getFotoduiFrontalUsuarios(); ?>">
                                                                    <h6><strong>Fotograf&iacute;a Cédula Reverso Cliente.</strong></h6>
                                                    ...
                                                    <!-- FOTO NIT CLIENTES -->
                                                    <button type="button" class="btn btn-light mb-2" data-toggle="modal" data-target="#fotonitclientes">Fotograf&iacute;a RUC Cliente <span class="btn-icon-right"><i class="fa fa-file-image-o"></i></span></button>
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="fotonitclientes">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <h6><strong>Fotograf&iacute;a Ruc Cliente.</strong></h6>
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-3">
                                                            <h5 class="f-w-500">Cédula <span class="pull-right">:</span>
                                                            </h5>
                                                        </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-3">
                                                            <h5 class="f-w-500">RUC <span class="pull-right">:</span>
                                                            </h5>
                                                        </div>
