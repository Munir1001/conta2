...
<head>
    ...
    <title>InversGlobal | Consulta General Transacciones Clientes</title>
    <!-- Favicon icon -->
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
                ...
                <div class="copyright">
                    <p><strong>&copy; Copyright <?php echo date('Y'); ?> InversGlobal Todos Los Derechos Reservados</strong></p>
                </div>
            </div>
        </div>
        <!--**********************************
                ...
                <div class="page-titles">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="--bs-breadcrumb-divider">
                            ...
                            <li class="breadcrumb-item active">Listado de Transacciones Crediticias</a></li>
                        </ol>
                    </nav>
                </div>
                <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Consultar, Ver Comprobantes Pagos Clientes InversGlobal</h4><br>
