...
?>
        ...
        <head>
            ...
            <title>InversGlobal | Gestor Nuevos Pr&eacute;stamos Veh&iacute;culos</title>
            <!-- Favicon icon -->
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <select class="form-control" id="val-productocreditos" name="productocreditos">
                                                                                        ...
                                                                                        while ($filas = mysqli_fetch_array($consulta1)) {
                                                                                            ...
                                                                                            if ($filas['nombreproducto'] != "Cuentas de Ahorro Personales" && $filas['nombreproducto'] != "Depósito a Plazo Fijo" && $filas['nombreproducto'] != "Microcrédito" && $filas['nombreproducto'] != "Préstamo de Consumo") {
                                                                                                echo '
                                                                    <option value="';
