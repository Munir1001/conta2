...
?>
        ...
        <head>
            ...
            <title>InversGlobal | Seleccionar Producto InversGlobal</title>
            <!-- Favicon icon -->
                                    ...
                                    <div class="col-xl-12">
                                        <div class="auth-form">
                                            ...
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="text-center">
                                                        ...
                                                        <p>Seleccionar Producto InversGlobal</p>
                                                    </div>
                                                    <div class="col-xl-12">
                                            ...
                                            <li><a href="';
                                                                ...
                                                                if ($filas['nombreproducto'] == "Préstamo de Consumo") {
                                                                    echo $UrlGlobal;
                                                                ...
                                                                if ($filas['nombreproducto'] == "Microcrédito") {
                                                                    echo $UrlGlobal;
                                                                    echo 'controlador/cGestionesCashman.php?cashmanhagestion=gestor-creditos-clientes-asignacion-prestamo-microcredito&idusuario=';
                                                                    echo $Gestiones->getIdUsuarios();
                                                                    echo '';
                                                                }
