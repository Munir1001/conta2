...
?>
        ...
        <head>
            ...
            <title>InversGlobal | Gestor Nuevos Microcréditos</title>
            <!-- Favicon icon -->
                                ...
                                <div class="row no-gutters">
                                    <div class="col-xl-12">
                                        <div class="auth-form">
                                            ...
                                            <h3 class="text-center mb-4">Gestor de Microcréditos</h3>
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="text-center">
                                                        ...
                                                        <p>Asignar Nuevo Microcréditos</p>
                                                        <!-- Button trigger modal -->
                                                        <button type="button" class="btn light btn-secondary" data-toggle="modal" data-target="#prestamospersonales">Requisitos Microcréditos</button>
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="prestamospersonales">
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title">Microcréditos</h5>
                                                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                                        </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <h4 class="text-primary mb-4">Microcréditos</h4>
                                    ...
                                    */
                                                        ...
                                                        ?>
                                                            <div class="col-xl-12">
                                                                <form data-id="<?php echo $Gestiones->getIdUsuarios(); ?>" id="ingreso-datos-credito-clientes" class="validacion-registro-credito-personal" name="formulariocreditosclientes" method="post" autocomplete="off" enctype="multipart/form-data" onKeyUp="ConsultarRequisitosMicrocreditos()">
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <select class="form-control" id="val-productocreditos" name="productocreditos">
                                                                                        ...
                                                                                        while ($filas = mysqli_fetch_array($consulta1)) {
                                                                                            ...
                                                                                            if ($filas['nombreproducto'] != "Cuentas de Ahorro Personales" && $filas['nombreproducto'] != "Depósito a Plazo Fijo" && $filas['nombreproducto'] != "Préstamo de Consumo") {
                                                                                                echo '
                                                                    <option value="';
                                                                    ...
                                                                    ';
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <div class="input-group mb-3  input-primary">
                                                                                        ...
                                                                                        <input type="number" class="form-control" id="valmontocreditoclientes" name="valmontocreditoclientes" placeholder="Ingrese monto de crédito" oninput="CalculoCuotaMensual()" min="200" max="100000" step="100" required>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <div class="input-group mb-3 input-primary">
                                                                                        ...
                                                                                        <input type="number" class="form-control" id="interescredito" name="interescredito" placeholder="Ingrese la Tasa de Interés Anual" oninput="CalculoCuotaMensual()" min="22" step="0.5" required>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-lg-6 mb-2">
                                                                            <div class="form-group">
                                                                                <label class="text-label">Tipo de Microcrédito <span class="text-danger">*</span></label>
                                                                                <div class="col-lg-12">
                                                                                    <div class="input-group mb-3 input-primary">
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text"><i class="ti ti-wallet"></i></span>
                                                                                        </div>
                                                                                        <select class="form-control" id="tipomicrocredito" name="tipomicrocredito" required>
                                                                                            <option value="">Seleccione el tipo de microcrédito</option>
                                                                                            <option value="200-1000">$200 a $1000 microcrédito minorista</option>
                                                                                            <option value="1001-10000">$1001 a $10000 microcrédito amplia
                                                                                                da simple</option>
                                                                                            <option value="10001-100000">$10001 a $100000 microcrédito ampliada</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
    ...
    ***********************************-->
                            ...
                            <script src="<?php echo $UrlGlobal; ?>vista/js/calculocuotamensualmicrocreditos.js"></script>
                            <script src="<?php echo $UrlGlobal; ?>vista/js/alerta-registro-nuevos-prestamos-clientes.js"></script>
                            <script src="<?php echo $UrlGlobal; ?>vista/js/ConsultarRequisitosMicrocreditos.js"></script>
                            <script>
