...
// IMPORTANDO MODELO RECUPERACION DE GESTIONES EMPRESARIALES InversGlobal
require('../modelo/mGestionesCashman.php');

// INICIALIZANDO VARIABLE GLOBAL DE CLASE
$Gestiones = new GestionesClientes($requiredArgument);

/*
        -> IMPORTANTE: ESTE PROYECTO CUENTA CON LA CONFIGURACION HORARIA DISPONIBLE EN LA REGION [PAIS -> Ecuador] UTC-5. EN CASO DE FUTURAS ADECUACIONES ESTE DEBE SER MODIFICADO SEGUN LA REGION A IMPLEMENTAR.
    ...
    */
// TIEMPO POR DEFECTO -> UTC - 5 Ecuador [CONSULTAR DOCUMENTACION OFICIAL]
...
// Obtener dominio correctamente (compatible con proxies)
$domain = $_SERVER['HTTP_HOST']; // Mejor que SERVER_NAME

// Construir URL base SIN puerto si es estándar
$UrlGlobal = $protocol . $domain . "/CashManHA/";
...
switch ($peticion_url) {
    ...
    case "inicioclientes":
        ...
        break;
    // PAGINA PRINCIPAL [INDEX] INTERFAZ USUARIOS LOGUEADOS NIVEL -> CONTABILIDAD
    case "iniciocontabilidad":
        if ($_SESSION['id_rol'] == 6) {
            ...
            // CONSULTA TOTAL DE INGRESOS PAGOS CUOTAS [TRANSACCIONES] CREDITOS PROCESADAS [SEGUN CODIGO UNICO DE EMPLEADOS]
            $consulta5 = $Gestiones->Consulta_TotalIngresosTransaccionesCreditosProcesadas_AtencionClientes($conectarsistema6, $CodigoUsuarios);
            require("../vista/Contabilidad/inicio-contabilidad.php");
            $conectarsistema->close(); // CERRANDO CONEXION PRINCIPAL
            // -> CIERRE DE CONEXIONES AUXILIARES
            $conectarsistema1->close(); // CERRANDO CONEXION AUXILIAR 1
            $conectarsistema2->close(); // CERRANDO CONEXION AUXILIAR 2
    ...
    case "perfiladministradores":
        ...
        if ($_SESSION['id_rol'] == 1) {
            $IdUsuarios = $_SESSION['id_usuario']; // ID UNICO DE USUARIOS
            // CONSULTA DETALLES DE USUARIOS {EMPLEADOS, CLIENTES InversGlobal} -> PERFIL DE USUARIOS
            $consulta = $Gestiones->ConsultarDetallesUsuarios($conectarsistema, $IdUsuarios);
            // CONSULTA CONFIGURACION CUENTA DE USUARIOS {EMPLEADOS, CLIENTES InversGlobal} -> PERFIL DE USUARIOS
    ...
    case "perfilcontabilidad":
        ...
        if ($_SESSION['id_rol'] == 6) {
            ...
            // LISTADO RECORTADO DE NOTIFICACIONES -> BARRA DE HERRAMIENTAS PLATAFORMA
            $consulta3 = $Gestiones->MostrarListadoNotificacionesRecortadaRecibidasUsuarios($conectarsistema3, $IdUsuarios);
            require("../vista/Contabilidad/perfil-contabilidad.php");
            $conectarsistema->close(); // CERRANDO CONEXION PRINCIPAL
            // -> CIERRE DE CONEXIONES AUXILIARES
            $conectarsistema1->close(); // CERRANDO CONEXION AUXILIAR 1
            $conectarsistema2->close(); // CERRANDO CONEXION AUXILIAR 2
    ...
    case "consultar-productos-cashmanha-atencion-clientes":
        ...
        break;
    // CONTABILIDAD
    case "consultar-productos-cashmanha-contabilidad":
        // VISTA VALIDA SOLO PARA GERENCIA
        if ($_SESSION['id_rol'] == 6) {
            $IdUsuarios = $_SESSION['id_usuario']; // ID UNICO DE USUARIO REGISTRADO
            // CONSULTA COMPLETA DE PRODUCTOS REGISTRADOS CASHMANHA [ACTIVOS]
            ...
            // LISTADO RECORTADO DE NOTIFICACIONES -> BARRA DE HERRAMIENTAS PLATAFORMA
            $consulta3 = $Gestiones->MostrarListadoNotificacionesRecortadaRecibidasUsuarios($conectarsistema3, $IdUsuarios);
            require('../vista/Contabilidad/consulta-general-productos-cashmanha-contabilidad.php');
            $conectarsistema->close(); // CERRANDO CONEXION PRINCIPAL
            // -> CIERRE DE CONEXIONES AUXILIARES
            $conectarsistema1->close(); // CERRANDO CONEXION AUXILIAR 1
            $conectarsistema2->close(); // CERRANDO CONEXION AUXILIAR 2
    ...
    case "consulta-productos-especifica-cashmanha":
        ...
        if ($_SESSION['id_rol'] == 1) {
            ...
            $consulta = $Gestiones->ConsultaGeneralProductos($conectarsistema, $IdProductos);
            // LISTADO RECORTADO DE NOTIFICACIONES -> BARRA DE HERRAMIENTAS PLATAFORMA
            $consulta1 = $Gestiones->MostrarListadoNotificacionesRecortadaRecibidasUsuarios($conectarsistema1, $IdUsuarios);
    ...
    case "consulta-productos-especifica-cashmanha-atencion-clientes":
        ...
        break;
    // CONTABILIDAD
    case "consulta-productos-especifica-cashmanha-contabilidad":
        // VISTA VALIDA PARA ATENCION AL CLIENTE
        if ($_SESSION['id_rol'] == 6) {
            $IdUsuarios = $_SESSION['id_usuario']; // ID UNICO DE USUARIO REGISTRADO
            $IdProductos = $_GET['idproducto']; // ID UNICO DE USUARIOS
            ...
            // LISTADO RECORTADO DE NOTIFICACIONES -> BARRA DE HERRAMIENTAS PLATAFORMA
            $consulta1 = $Gestiones->MostrarListadoNotificacionesRecortadaRecibidasUsuarios($conectarsistema1, $IdUsuarios);
            require('../vista/Contabilidad/consulta-especifica-productos-cashmanha-contabilidad.php');
            $conectarsistema->close(); // CERRANDO CONEXION PRINCIPAL
            // -> CIERRE DE CONEXIONES AUXILIARES
            $conectarsistema1->close(); // CERRANDO CONEXION AUXILIAR 1
            $conectarsistema2->close(); // CERRANDO CONEXION AUXILIAR 2
    ...
    case "consulta-contabilidad-cashmanha-contabilidad":
        // VISTA VALIDA PARA CONTABILIDAD
        if ($_SESSION['id_rol'] == 6) {
            $IdUsuarios = $_SESSION['id_usuario']; // ID UNICO DE USUARIO REGISTRADO
            // CONSULTA ESPECIFICA DETALLES DE PRODUCTOS REGISTRADOS
            // LISTADO RECORTADO DE NOTIFICACIONES -> BARRA DE HERRAMIENTAS PLATAFORMA
            $consulta1 = $Gestiones->MostrarListadoNotificacionesRecortadaRecibidasUsuarios($conectarsistema1, $IdUsuarios);
            require('../vista/Contabilidad/consulta-contabilidad-cashmanha-contabilidad.php');
            ...
            // SI EL USUARIO NO TIENE EL ROL CORRECTO, REDIRECCIONA A PAGINA PRINCIPAL DE PORTAL SEGUN SU ROL DE USUARIO ASIGNADO
            header('location:cGestionesCashman.php?cashmanhagestion=redirecciones-sistema-cashmanha');
    ...
    case "reestructuracion-solicitudes-creditos-clientes-presidencia":
        ...
        break;
    // PAGINA DE ASIGNACION DE NUEVOS CREDITOS CLIENTES InversGlobal [INFORMACION CLIENTES]
    ...
    case "gestor-creditos-seleccion-producto-clientes":
        ...
        break;
    // PAGINA DE ASIGNACION DE NUEVOS CREDITOS CLIENTES InversGlobal [PRESTAMOS PERSONALES]
    ...
    case "envio-datos-asignacion-prestamos-cashmanha-clientes":
        ...
        if ($_SESSION['id_rol'] >= 1 && $_SESSION['id_rol'] <= 4) {
            ...
            $InteresCredito = (empty($_POST['interescredito'])) ? NULL : floatval($_POST['interescredito']); // TASA DE INTERES CREDITO
            ...
            $TipoPago = (empty($_POST['valtipopago'])) ? NULL : $_POST['valtipopago']; // TIPO PAGO - MENSUAL / SEMANAL / QUIMESTRAL
            $TipoAmortizacion = (empty($_POST['valtipoamortizacion'])) ? NULL : $_POST['valtipoamortizacion']; // TIPO AMORTIZACION - FIJA / VARIABLE
            ...
            if (empty($TipoCliente)) {
                ...
                $consulta = $Gestiones->RegistroNuevaAsignacionesCreditosClientes($conectarsistema, $IdUsuarios, $IdProductos, $TipoCliente, $MontoCredito, $InteresCredito, $PlazoCredito, $CuotaMensualCredito, $FechaSolicitud, $SalarioCliente, $SaldoActualCreditos, $ObservacionesCredito, $CodigoEmpleadoGestion, $TipoPago, $TipoAmortizacion);
                // ENVIANDO RESPUESTA DE ACCION A MODELO
                echo json_encode($consulta);
            }
            $conectarsistema->close(); // CERRANDO CONEXION
        ...
        break;
    // PAGINA DE ASIGNACION DE REFERENCIAS PERSONALES CLIENTES NUEVOS / ANTIGUOS -> InversGlobal
    ...
    case "envio-datos-modificar-referencias-personales-laborales-clientes":
        ...
        break;
    // PAGINA DE ASIGNACION DE NUEVOS CREDITOS CLIENTES InversGlobal [PRESTAMOS HIPOTECARIOS]
    case "gestor-creditos-clientes-asignacion-prestamo-microcredito":
        // VISTA VALIDA PARA ADMINISTRADORES, PRESIDENCIA, GERENCIA, ATENCION AL CLIENTE
        // LOS EMPLEADOS DE [ATENCION AL CLIENTE] SON QUIENES PRINCIPALMENTE GESTIONARAN TODAS LAS NUEVAS SOLICITUDES CREDITICIAS -> EN CASOS MUY PUNTUALES PUEDE HACERLO LOS OTROS ROLES DE USUARIOS EXCLUYENDO A [CLIENTES]
        if ($_SESSION['id_rol'] >= 1 && $_SESSION['id_rol'] <= 4) {
            $IdUsuarios = (empty($_GET['idusuario'])) ? NULL :  $_GET['idusuario']; // ID UNICO DE USUARIOS
            ...
            // CONSULTA ID UNICO DE CREDITO SOLICITADO POR CLIENTE
            $consulta2 = $Gestiones->ConsultaIdUnicoCreditosClientes($conectarsistema2, $IdUsuarios);
            require('../vista/gestor-nuevos-creditos-microcreditos.php');
            $conectarsistema->close(); // CERRANDO CONEXION PRINCIPAL
            // -> CIERRE DE CONEXIONES AUXILIARES
            $conectarsistema1->close(); // CERRANDO CONEXION AUXILIAR 1
            $conectarsistema2->close(); // CERRANDO CONEXION AUXILIAR 2
    ...
    case "envio-datos-revisiones-solicitudes-nuevas-creditos-clientes":
        if ($_SESSION['id_rol'] == 1 || $_SESSION['id_rol'] == 2 || $_SESSION['id_rol'] == 3) {
            ...
            if (empty($IdCreditos)) {
                ...
                $consulta = $Gestiones->ActualizacionPrimeraRevisionNuevaAsignacionesCreditosClientes($conectarsistema, $IdCreditos, $TipoCliente, $MontoCredito, $PlazoCredito, $CuotaMensualCredito, $SalarioCliente, $NuevoSaldoCreditosClientes, $EstadoActualCreditos, $ObservacionesCredito, $ProgresoInicialSolicitudCreditos, $FechaUltimaActualizacionRevision, $CodigoEmpleadoGestion, $TipoPago, $TipoAmortizacion);
                // ENVIANDO RESPUESTA DE ACCION A MODELO
                echo json_encode($consulta);
            }
            $conectarsistema->close(); // CERRANDO CONEXION
    ...
    case "impresion-estado-cuenta-cuotas-nuevos-creditos":
        // VISTA VALIDA PARA ADMINISTRADORES
        if ($_SESSION['id_rol'] == 1) {
            $IdUsuarios = $_GET['idusuario']; // ID UNICO DE USUARIOSconectarsistema: conectarsistema: 
            // CONSULTA COMPLETA DE CLIENTE CON TODOS LOS REQUERIMIENTOS SOLICITADOS EN SOLICITUD DE CREDITO
            $consulta = $Gestiones->ConsultaDatosSolicitudesCreditosClientesAprobados($conectarsistema, $IdUsuarios);
            // CONSULTA PRODUCTOS ACTIVOS -> ASIGNACIONES NUEVOS CREDITOS
            $consulta1 = $Gestiones->ConsultarProductosActivosNuevosCreditos($conectarsistema1);
            // CONSULTA GENERAL DE CUOTAS GENERADAS SEGUN PRODUCTO ASOCIADO CLIENTES InversGlobal
    ...
    case "impresion-estado-cuenta-cuotas-nuevos-creditos-portal-clientes":
        // VISTA VALIDA PARA CLIENTES [PORTAL DE CLIENTES InversGlobal]
        if ($_SESSION['id_rol'] == 5) {
            $IdUsuarios = $_SESSION['id_usuario']; // ID UNICO DE USUARIOS
            // CONSULTA COMPLETA DE CLIENTE CON TODOS LOS REQUERIMIENTOS SOLICITADOS EN SOLICITUD DE CREDITO
            $consulta = $Gestiones->ConsultaDatosSolicitudesCreditosClientesAprobados($conectarsistema, $IdUsuarios);
    ...
    case "envio-datos-estado-cuenta-creditos-clientes":
        if ($_SESSION['id_rol'] >= 1 && $_SESSION['id_rol'] <= 4) {
            ...
            $IdCreditos = (empty($_POST['CodigoUnicoCreditoEstadoCuenta'])) ? NULL : $_POST['CodigoUnicoCreditoEstadoCuenta'];
            $IdUsuarios = (empty($_POST['CodigoUnicoCreditoEstadoCuenta'])) ? NULL : $_POST['CodigoUnicoUsuarioEstadoCuenta'];
            $IdProductos = (empty($_POST['CodigoUnicoProductoEstadoCuenta'])) ? NULL : $_POST['CodigoUnicoProductoEstadoCuenta'];
            $NombreProductos = (empty($_POST['NombreProductoEstadoCuenta'])) ? NULL : $_POST['NombreProductoEstadoCuenta'];
            $FechaSolicitud = (empty($_POST['FechaPagoEstadoCuenta'])) ? NULL : $_POST['FechaPagoEstadoCuenta'];
            $MontoCapitalCredito = (empty($_POST['MontoCapitalEstadoCuenta'])) ? NULL : (float)$_POST['MontoCapitalEstadoCuenta'];
            $TasaInteres = (empty($_POST['TasaInteresEstadoCuenta'])) ? NULL : (float)$_POST['TasaInteresEstadoCuenta'];
            $PlazoCredito = (empty($_POST['PlazoPagoEstadoCuenta'])) ? NULL : (int)$_POST['PlazoPagoEstadoCuenta'];
            $TipoPago = (empty($_POST['TipoPagoEstadoCuenta'])) ? 'mensual' : $_POST['TipoPagoEstadoCuenta'];
            $TipoAmortizacion = (empty($_POST['TipoAmortizacionEstadoCuenta'])) ? 'fija' : $_POST['TipoAmortizacionEstadoCuenta'];

            // Configure payment periods based on payment type
            $periodoConfig = [
                'mensual' => ['multiplicador' => 1, 'divisor' => 12, 'intervalo' => 'P1M'],
                'quincenal' => ['multiplicador' => 2, 'divisor' => 24, 'intervalo' => 'P15D'],
                'semanal' => ['multiplicador' => 4, 'divisor' => 48, 'intervalo' => 'P7D']
            ];

            $config = $periodoConfig[$TipoPago] ?? $periodoConfig['mensual'];

            // Validate day of entry
            $ValidarDiaIngresoSolicitud = $FechaSolicitud;
            $ExtraerFechaSolicitud = strtotime($FechaSolicitud);
            $ObtenerDiaSolicitud = date("d", $ExtraerFechaSolicitud);

            if ($ObtenerDiaSolicitud >= 29 && $ObtenerDiaSolicitud <= 31) {
                $PlazoCredito = (empty($_POST['PlazoPagoEstadoCuenta'])) ? NULL : $_POST['PlazoPagoEstadoCuenta'];
            } else {
                $PlazoCredito = (empty($_POST['PlazoPagoEstadoCuenta'])) ? NULL : $_POST['PlazoPagoEstadoCuenta'] + 1;
            }

            if (empty($IdCreditos)) {
                header('location:cGestionesCashman.php?cashmanhagestion=redirecciones-sistema-cashmanha');
            } else {
                // Calculate total periods and interest rate per period
                $TotalPeriodos = $PlazoCredito * $config['multiplicador'];
                $TasaInteresPeriodo = $TasaInteres / 100 / $config['divisor'];

                // Initial calculations for insurance and savings
                $SeguroDesgravamenInicial = $MontoCapitalCredito * 0.00043;
                $AhorroProgramadoInicial = $MontoCapitalCredito * 0.00025;

                // Calculate initial payment based on amortization type
                if ($TipoAmortizacion === "fija") {
                    $CuotaMensualCredito = ($MontoCapitalCredito * $TasaInteresPeriodo * pow(1 + $TasaInteresPeriodo, $TotalPeriodos))
                        / (pow(1 + $TasaInteresPeriodo, $TotalPeriodos) - 1);
                    $CuotaCapital = null;
                } else {
                    $CuotaCapital = $MontoCapitalCredito / $TotalPeriodos;
                    $CuotaMensualCredito = $CuotaCapital + ($MontoCapitalCredito * $TasaInteresPeriodo);
                }

                // Date calculations
                $CompletarFecha = 0;
                $IntervaloFecha = new DateInterval($config['intervalo']);
                $InicioCreditos = new DateTime($FechaSolicitud);

                // Adjust initial date based on payment type
                if ($TipoPago === 'quincenal') {
                    $InicioCreditos->add(new DateInterval('P16D'));
                } else if ($TipoPago === 'semanal') {
                    $InicioCreditos->add(new DateInterval('P8D'));
                } else {
                    $InicioCreditos->add(new DateInterval('P1M1D'));
                }

                // Calculate end date
                $FinCreditos = clone $InicioCreditos;
                $FinCreditos->add(new DateInterval('P' . $PlazoCredito . 'M'));

                // Generate payment schedule
                $CuotasMensualesGeneradas = new DatePeriod($InicioCreditos, $IntervaloFecha, $FinCreditos);

                $SaldoInicial = $MontoCapitalCredito;
                $ContadorCuotas = 0;
                ...
                foreach ($CuotasMensualesGeneradas as $DiaAsignado) {
                    ...
                    if ($ContadorCuotas > 1) {
                        ...
                        if ($TipoAmortizacion === "fija") {
                            $Interes = $SaldoInicial * $TasaInteresPeriodo;
                            $Capital = $CuotaMensualCredito - $Interes;
                        } else {
                            $Capital = $CuotaCapital;
                            $Interes = $SaldoInicial * $TasaInteresPeriodo;
                            $CuotaMensualCredito = $Capital + $Interes;
                        }

                        $SaldoFinal = $SaldoInicial - $Capital;

                        // Calculate insurance and savings
                        $factor = ($TotalPeriodos - $ContadorCuotas + 1) / $TotalPeriodos;
                        $SeguroDesgravamen = $SeguroDesgravamenInicial * $factor;
                        $AhorroProgramado = $AhorroProgramadoInicial * $factor;
                        ...
                        if ($DiaLaboral == '7') {
                            $DiaAsignado->modify('-2 days');
                            $FechaPago = $DiaAsignado->format('Y-m-d');
                        } else if ($DiaLaboral == '6') {
                            $DiaAsignado->modify('-1 days');
                            $FechaPago = $DiaAsignado->format('Y-m-d');
                        }

                        // Calculate total payment including insurance and savings
                        $CuotaTotal = $CuotaMensualCredito + $SeguroDesgravamen + $AhorroProgramado;

                        // Register payment in database
                        $consulta = $Gestiones->RegistroAsignacionCuotasMensualesClientes(
                            $conectarsistema,
                            $IdCreditos,
                            $IdProductos,
                            $IdUsuarios,
    ...
    case "envio-datos-actualizacion-tickets-problemas-plataforma":
        ...
        break;
    // PAGINA DE SISTEMA DE PAGOS CUOTAS CREDITOS CLIENTES InversGlobal -> DISPONIBLE PARA LOS USUARIOS ADMINISTRATIVOS -> [ADMINISTRADORES Y ATENCION AL CLIENTE]
    ...
    case "sistema-pagos-creditos-cashmanha-clientes-atencion-al-cliente":
        ...
        break;
    // PAGINA DE SISTEMA DE PAGOS CUOTAS CREDITOS CLIENTES InversGlobal [ESPECIFICAMENTE ORDENES DE PAGO SEGUN LA CUOTA A CANCELAR {ID DE CUOTA GENERADA EN SISTEMA}] -> DISPONIBLE PARA LOS USUARIOS ADMINISTRATIVOS -> [ADMINISTRADORES Y ATENCION AL CLIENTE]
    ...
    case "facturacion-pago-ordenes-pago-cuotas-clientes":
        if ($_SESSION['id_rol'] >= 1 && $_SESSION['id_rol'] <= 5) {
            // Verificar si es una solicitud de comprobante individual
            $IdCuotas = (empty($_GET['idcuota'])) ? NULL : $_GET['idcuota']; // ID CUOTA UNICO ASOCIADO A CLIENTE -> PRODUCTO -> CREDITO
            $IdUsuarios = (empty($_GET['idusuario'])) ? NULL : $_GET['idusuario']; // ID UNICO DE USUARIO REGISTRADO

            if ($IdCuotas && $IdUsuarios) {
                // CONSULTAR DETALLES DE FACTURACION CREDITOS CLIENTES (COMPROBANTE INDIVIDUAL)
                ...
                // CONSULTA PAGINADA PARA LISTADO DE TRANSACCIONES

                // Parámetros de búsqueda y paginación
                $busqueda = isset($_GET['busqueda']) ? trim($_GET['busqueda']) : '';
                $fecha_inicio = isset($_GET['fecha_inicio']) ? $_GET['fecha_inicio'] : date('Y-m-d', strtotime('-1 month'));
                $fecha_fin = isset($_GET['fecha_fin']) ? $_GET['fecha_fin'] : date('Y-m-d');
                $por_pagina = isset($_GET['por_pagina']) && in_array($_GET['por_pagina'], [10, 25, 50, 100]) ? (int)$_GET['por_pagina'] : 10;
                ...
                // Consulta paginada
                $consulta = $Gestiones->ConsultarPagosCreditosClientesPaginado(
                    $conectarsistema,
                    $idUsuarioLogueado,
                    $busqueda,
                    $fecha_inicio,
                ...
                $totalPagos = $Gestiones->ContarTotalPagosCreditosClientes(
                    $conectarsistema,
                    $idUsuarioLogueado,
                    $busqueda,
                    $fecha_inicio,
                ...
                $totalPaginas = ceil($totalPagos / $por_pagina);

                require('../vista/ClientesPagosCreditos.php');
            }
    ...
    case "consulta-general-transacciones-procesadas-por-clientes-gerencia":
        ...
        break;
    // PAGINA DE MENSAJERIA INTERNA InversGlobal -> VALIDO PARA TODOS LOS USUARIOS ADMINISTRATIVOS [ADMINISTRADORES, PRESIDENCIA, GERENCIA, ATENCION AL CLIENTE Y CLIENTES]
    ...
    case "mensajeria-cashmanha-usuarios-clientes":
        ...
        break;
    // PAGINA DE DETALLES MENSAJERIA INTERNA InversGlobal -> VALIDO UNICAMENTE PARA TODOS LOS USUARIOS [ADMINISTRADORES, PRESIDENCIA, GERENCIA, ATENCION AL CLIENTE Y CLIENTES]
    ...
    case "detalle-mensajeria-cashmanha-usuarios-clientes":
        ...
        break;
    // PAGINA DE ENVIO MENSAJERIA INTERNA InversGlobal -> VALIDO UNICAMENTE USUARIOS ADMINISTRATIVOS [NO APLICABLE PARA CLIENTES InversGlobal]
    ...
    case "envio-datos-ocultar-notificaciones-usuarios":
        ...
        break;
    // REGISTRO DE NUEVAS CUENTAS DE AHORROS CLIENTES InversGlobal -> VALIDO PARA ADMINISTRADORES Y ATENCION AL CLIENTE
    ...
    case "registro-nuevas-cuentas-ahorro-atencion-clientes":
        ...
        break;
    // ENVIO DATOS REGISTRO DE NUEVAS CUENTAS DE AHORRO CLIENTES InversGlobal [ENVIO A BASE DE DATOS]
    case "envio-datos-registro-nuevas-cuentas-ahorro-clientes":
        ...
        if ($_SESSION['id_rol'] == 1 || $_SESSION['id_rol'] == 4) {
            ...
            $MontoApertura = (empty($_POST['val-montodepositoapertura'])) ? NULL : $_POST['val-montodepositoapertura']; // MONTO DE APERTURA DEPOSITADO POR CLIENTES
            $MontoDepositoAperturaCuenta = 0;

            // Determinar el IdProductos según el tipo de cuenta seleccionado
            $tipoCuenta = $_POST['tipo-cuenta']; // Obtiene el valor del tipo de cuenta seleccionado
            if ($tipoCuenta == 'cuenta-ahorro') {
                $IdProductos = 1; // Cuenta de Ahorro
            } else if ($tipoCuenta == 'cuenta-mi-futuro') {
                $IdProductos = 2; // Cuenta de Ahorro "Mi Futuro" (niños)
            }

            $IdUsuarios = (empty($_POST['val-clientecuentaahorro'])) ? NULL : $_POST['val-clientecuentaahorro']; // ID UNICO DE USUARIO / CLIENTE REGISTRADO

            // Verificar si el usuario ya posee una cuenta de ahorro
            $consultaExistente = $Gestiones->ConsultarCuentaAhorroCliente($conectarsistema, $IdUsuarios, $IdProductos);

            if ($consultaExistente) {
                // Si ya existe una cuenta de ahorro para este usuario
                echo json_encode(["status" => "error", "message" => "El usuario ya posee una cuenta de ahorro."]);
            } elseif (empty($NumeroCuentaClientes)) {
                // SI EL USUARIO SE ENCUENTRA LOGUEADO, REDIRECCIONA A PAGINA PRINCIPAL DE PORTAL SEGUN SU ROL DE USUARIO ASIGNADO
                header('location:cGestionesCashman.php?cashmanhagestion=redirecciones-sistema-cashmanha');
            } else {
                // Calcular valores de certificado_aportacion y gastos_administrativos
                $certificadoAportacion = $MontoApertura * 0.75;
                $gastosAdministrativos = $MontoApertura * 0.25;

                // Registrar la nueva cuenta con los valores calculados
                $consulta = $Gestiones->RegistroNuevasCuentasAhorroClientesCashmanha(
                    $conectarsistema,
                    $NumeroCuentaClientes,
                    $MontoDepositoAperturaCuenta,
                    $IdProductos,
                    $IdUsuarios,
        ...
        case "envio-datos-registro-nuevas-cuentas-ahorro-programado":
            if ($_SESSION['id_rol'] == 1 || $_SESSION['id_rol'] == 4) {
                $NumeroCuentaClientes = $_POST['val-numerocuentaahorro-progamado'] ?? null;
                $MontoAhorro = $_POST['val-montodeahorro'] ?? null;
                $MesesAhorro = $_POST['val-mesesahorro'] ?? null;
                $IdUsuarios = $_POST['val-clientecuentaahorroprogramado'] ?? null;
                $InteresAnual = $_POST['val-interesanual-programado'] ?? null; // Capture interest rate
                
                // Verificar si el usuario tiene cuenta de ahorro normal (producto 1)
                $tieneCuentaAhorro = $Gestiones->ConsultarCuentaAhorroCliente($conectarsistema, $IdUsuarios, 1);
                if (!$tieneCuentaAhorro) {
                    header('Content-Type: application/json');
                    echo json_encode(["status" => "error", "message" => "El usuario no tiene cuenta de ahorro."]);
                    exit;
                }
        
                // Verificar si ya tiene cuenta de ahorro programado (producto 2)
                $tieneAhorroProgramado = $Gestiones->ConsultarCuentaAhorroProgramadoCliente($conectarsistema, $IdUsuarios, 2);
                if ($tieneAhorroProgramado) {
                    header('Content-Type: application/json');
                    echo json_encode(["status" => "error", "message" => "El usuario ya tiene cuenta programado."]);
                    exit;
                }
        
                // Calculate total savings without interest
                $totalAhorro = $MontoAhorro * $MesesAhorro;
                
                // Calculate interest and total disbursement amount
                $interesTotal = $totalAhorro * ($InteresAnual / 100);
                $totalDesembolso = $totalAhorro + $interesTotal;
                
                // Calculate start date (first day of next month) and end date
                $fechaInicio = date('Y-m-d', strtotime('first day of next month'));
                $fechaFiniquito = date('Y-m-d', strtotime($fechaInicio . ' + ' . $MesesAhorro . ' months - 1 day'));
        
                // Registrar la cuenta
                $registro = $Gestiones->RegistroNuevasCuentasAhorroProgramadoClientesCashmanha(
                    $conectarsistema,
                    $NumeroCuentaClientes,
                    $MontoAhorro,
                    1, // ID del producto ahorro programado
                    $IdUsuarios,
                    $MesesAhorro,
                    $InteresAnual,
                    $totalAhorro,
                ...
                if ($registro) {
                    header('Content-Type: application/json');
                    echo json_encode(["status" => "success", "message" => "Cuenta registrada exitosamente."]);
                } else {
                    header('Content-Type: application/json');
    ...
    case "gestionador-cuentas-ahorros-clientes-atencion-clientes":
        ...
        break;
    // REGISTRO NUEVOS DEPOSITOS CUENTAS DE AHORROS CLIENTES InversGlobal
    ...
    case "deposito-cuentas-ahorros-clientes":
        ...
        if ($_SESSION['id_rol'] == 1) {
            ...
            $consulta1 = $Gestiones->ConsultarUltimoIdRegistroTransaccion_CuentasClientes($conectarsistema1);
            // LISTADO RECORTADO DE NOTIFICACIONES -> BARRA DE HERRAMIENTAS PLATAFORMA
            $consulta2 = $Gestiones->MostrarListadoNotificacionesRecortadaRecibidasUsuarios($conectarsistema2, $IdUsuarioSistema);
    ...
    case "envio-datos-registro-depositos-cuentas-ahorros-clientes":
        ...
        if ($_SESSION['id_rol'] == 1 || $_SESSION['id_rol'] == 4) {
            ...
            $ReferenciaTransaccionDepositoCuentas = 'D#' . substr(bin2hex(openssl_random_pseudo_bytes(4)), 0, 8); // ID DE TRANSACCION UNICO DEPOSITOS CUENTAS AHORRO CLIENTES
            ...
            if (empty($IdCuentaAhorroClientes)) {
                ...
                $consulta = $Gestiones->RegistroDepositosCuentasAhorroClientes($conectarsistema, $IdUsuarios, $IdProductos, $IdCuentaAhorroClientes, $ReferenciaTransaccionDepositoCuentas, $MontoDepositoCuentas, $EmpleadoGestionTransaccionDepositoCuentas, $TipoTransaccionDepositosRetirosCuentas, $EstadoTransaccionDepositosRetirosCuentas, $CalculoNuevoSaldoDepositosRetirosCuentas);
                // ENVIANDO RESPUESTA DE ACCION A MODELO
                echo json_encode($consulta);
            }
            $conectarsistema->close(); // CERRANDO CONEXION
    ...
    case "impresion-comprobantes-transacciones-cuentas-clientes":
        ...
        break;
    // REGISTRO NUEVOS RETIROS CUENTAS DE AHORROS CLIENTES InversGlobal
    // VALIDO PARA ADMINISTRADORES Y ATENCION AL CLIENTE
    ...
    case "envio-datos-registro-retiros-cuentas-ahorros-clientes":
        ...
        if ($_SESSION['id_rol'] == 1 || $_SESSION['id_rol'] == 4) {
            ...
            $IdProductos = 1; // ID UNICO DE PRODUCTO REGISTRADO
            $IdCuentaAhorroClientes = (empty($_POST['IdCuentaAhorro'])) ? NULL : $_POST['IdCuentaAhorro']; // ID UNICO DE CUENTA REGISTRADA -> CUENTAS AHORRO CLIENTES
            $ReferenciaTransaccionDepositoCuentas = 'R#' . substr(bin2hex(openssl_random_pseudo_bytes(4)), 0, 8); // ID DE TRANSACCION UNICO DEPOSITOS CUENTAS AHORRO CLIENTES
            ...
            if (empty($IdCuentaAhorroClientes)) {
                ...
                $consulta = $Gestiones->RegistroRetirosCuentasAhorroClientes($conectarsistema, $IdUsuarios, $IdProductos, $IdCuentaAhorroClientes, $ReferenciaTransaccionDepositoCuentas, $MontoDepositoCuentas, $EmpleadoGestionTransaccionDepositoCuentas, $TipoTransaccionDepositosRetirosCuentas, $EstadoTransaccionDepositosRetirosCuentas, $CalculoNuevoSaldoDepositosRetirosCuentas);
                // ENVIANDO RESPUESTA DE ACCION A MODELO
                echo json_encode($consulta);
            }
            $conectarsistema->close(); // CERRANDO CONEXION
    ...
    case "consulta-transacciones-cuentas-clientes":
        ...
        if ($_SESSION['id_rol'] == 1) {
            ...
            $tipoTransaccion = $_GET['tipo_transaccion'] ?? 'all';
            $estadoTransaccion = $_GET['estado_transaccion'] ?? 'all';
            $paginaActual = $_GET['pagina'] ?? 1;
            $registrosPorPagina = $_GET['por_pagina'] ?? 10;

            // Validar y sanitizar parámetros
            $paginaActual = max(1, intval($paginaActual));
            $registrosPorPagina = in_array($registrosPorPagina, [10, 25, 50, 100]) ? $registrosPorPagina : 10;

            // CONSULTA COMPLETA DATOS DE CUENTAS CLIENTES
            $consulta = $Gestiones->ConsultaEspecificaClientes_CuentasAhorros($conectarsistema, $IdUsuarios);

            // CONSULTA TRANSACCIONES CON FILTROS Y PAGINACIÓN
            $consulta1 = $Gestiones->ConsultaMisTransaccionesCuentasClientes(
                $conectarsistema1,
                $IdUsuarios,
                $fechaInicio,
                $fechaFin,
            ...
            // Obtener total de registros para paginación
            $totalTransacciones = $Gestiones->ObtenerTotalTransaccionesCuentasClientes(
                $conectarsistema3,
                $IdUsuarios,
                $fechaInicio,
                $fechaFin,
            ...
            $totalPaginas = ceil($totalTransacciones / $registrosPorPagina);
    ...
    case "consulta-transacciones-procesadas-cuentas-clientes":
        ...
        if ($_SESSION['id_rol'] == 1) {
            ...
            // Validar y sanitizar parámetros
            $busqueda = substr(trim($_GET['busqueda'] ?? ''), 0, 255);
            $numero_cuenta = ctype_digit($_GET['numero_cuenta'] ?? '') ? $_GET['numero_cuenta'] : '';

            // Validar fechas
            $fecha_inicio = (DateTime::createFromFormat('Y-m-d', $_GET['fecha_inicio'] ?? '') !== false) ? $_GET['fecha_inicio'] : '';
            $fecha_fin = (DateTime::createFromFormat('Y-m-d', $_GET['fecha_fin'] ?? '') !== false) ? $_GET['fecha_fin'] : '';

            // Validar tipo de transacción
            $tipo_transaccion = in_array($_GET['tipo_transaccion'] ?? '', ['Entrada', 'Salida', 'Transferencia', 'all']) ? $_GET['tipo_transaccion'] : 'all';

            // Validar paginación
            $por_pagina = filter_var($_GET['por_pagina'] ?? 10, FILTER_VALIDATE_INT, [
                'options' => [
                    'default' => 10,
                    'min_range' => 1,
                    'max_range' => 100
            ...
            try {
                ...
                $consulta = $Gestiones->ConsultaFiltradaTransaccionesProcesadas(
                    $conectarsistema,
                    $busqueda,
                    $numero_cuenta,
                    $fecha_inicio,
                ...
                $totalTransacciones = $Gestiones->ContarTransaccionesProcesadasFiltradas(
                    $conectarsistema1,
                    $busqueda,
                    $numero_cuenta,
                    $fecha_inicio,
                ...
                // Calcular total de páginas
                $totalPaginas = max(ceil($totalTransacciones / $por_pagina), 1);

                // LISTADO RECORTADO DE NOTIFICACIONES
                $consulta2 = $Gestiones->MostrarListadoNotificacionesRecortadaRecibidasUsuarios($conectarsistema2, $IdUsuarios);
                ...
                $_SESSION['mensaje_error'] = "Ocurrió un error al procesar la consulta";
                header('Location: cGestionesCashman.php?cashmanhagestion=dashboard');
                exit();
            } finally {
                // Cerrar conexiones
                $conectarsistema->close();
    ...
    case "consulta-transacciones-anuladas-cuentas-clientes":
        if ($_SESSION['id_rol'] == 1) {
            $IdUsuarios = $_SESSION['id_usuario'];

            // Misma validación que en el caso anterior
            $busqueda = substr(trim($_GET['busqueda'] ?? ''), 0, 255);
            $numero_cuenta = ctype_digit($_GET['numero_cuenta'] ?? '') ? $_GET['numero_cuenta'] : '';
            $fecha_inicio = (DateTime::createFromFormat('Y-m-d', $_GET['fecha_inicio'] ?? '') !== false) ? $_GET['fecha_inicio'] : '';
            $fecha_fin = (DateTime::createFromFormat('Y-m-d', $_GET['fecha_fin'] ?? '') !== false) ? $_GET['fecha_fin'] : '';
            ...
            try {
                // CONSULTA GENERAL CON FILTROS PARA ANULADAS
                $consulta = $Gestiones->ConsultaFiltradaTransaccionesAnuladas(
                    $conectarsistema,
                    $busqueda,
                    $numero_cuenta,
                    $fecha_inicio,
                ...
                $totalTransacciones = $Gestiones->ContarTransaccionesAnuladasFiltradas(
                    $conectarsistema1,
                    $busqueda,
                    $numero_cuenta,
                    $fecha_inicio,
                ...
                error_log("Error en consulta de transacciones anuladas: " . $e->getMessage());
                $_SESSION['mensaje_error'] = "Ocurrió un error al procesar la consulta";
                header('Location: cGestionesCashman.php?cashmanhagestion=dashboard');
                exit();
            } finally {
    ...
    case "generador-codigos-transferencias-clientes":
        ...
        if ($_SESSION['id_rol'] >= 1 && $_SESSION['id_rol'] <= 5) {
            ...
            $Asunto = "Código Seguridad - Transferencias InversGlobal"; // ASUNTO POR DEFECTO DE CORREO
            ...
            if (empty($IdUsuarios)) {
                                                ...
                                                <table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%' style='margin: auto;'>
                                                            ...
                                                            <table role='presentation' border='0' cellpadding='0' cellspacing='0' width='100%'>
                                                                <tr>
                                                                    <td class='logo' style='text-align: center;'>
                                                                        <h1><a href='#'><img style='width: 70px; max-width: 70px; height: auto; margin: auto; display: block;' src='https://raw.githubusercontent.com/Munir1001/images/refs/heads/main/logo-negro.png'></a></h1>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td valign='middle' class='hero bg_white' style='padding: 3em 0 2em 0; background: #ffffff;'>
                                                            <img src='http://raw.githubusercontent.com/Munir1001/images/refs/heads/main/payment-processed.gif' style='width: 70px; max-width: 70px; height: auto; margin: auto; display: block;'>
                                                        </td>
                                                    </tr>
                                                    <tr>
                ...
                try {
                    $response = $apiInstance->emailsPost($email);
                    ...
                    echo json_encode([
                        "status" => "error",
                        "message" => "Error al procesar el envió de su código. Intentelo de nuevo.",
    ...
    case "envio-datos-procesamiento-transferencias-clientes":
        ...
        if ($_SESSION['id_rol'] >= 1 && $_SESSION['id_rol'] <= 5) {
            ...
            $ReferenciaTransferencia = 'T#' . substr(bin2hex(openssl_random_pseudo_bytes(4)), 0, 8); // ID DE TRANSACCION MAS CORTO // ID DE TRANSACCION UNICO DEPOSITOS CUENTAS AHORRO CLIENTES
